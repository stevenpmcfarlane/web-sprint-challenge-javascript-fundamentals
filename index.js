...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// pmrNested function can access the the variable internal due to closures. The information stored in a variable or function can be stored and used inside the scope of another function (or a separate lexicall environment) as long as you follow certain rules. Those rules include using callback functions inside of higher order functions, or going from global scope to function scope, but not vice SVGPathSegLinetoVerticalAbs.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(){
    return zooAnimals.filter(function(objects){
      return objects.population < 5;
    })
  }
